...
public class Barbarian extends CharacterClass {
    ...
    public Barbarian() {
        ...
        this.features = new String[] {//Level 1
                "Rage:\r\n" 
                + "On your turn, you can enter a rage as a bonus action that lasts for 1 minute or if you are knocked unconscious or if your turn ends and you haven't attacked a hostile creature since your last turn or taken damage since then.\r\n"
                + "\r\n"
